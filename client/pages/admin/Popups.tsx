...
import { Save, Upload, Image as ImageIcon, Plus, Trash2, Star, Mail, Settings, Eye } from "lucide-react";
import { cn } from "@/lib/utils";
import { supabase } from "@/lib/supabaseClient";
import { usePopups } from "@/hooks/use-popups";

export default function Popups() {
  const { productPopupData, exitIntentPopupData, updateProductPopupData, updateExitIntentPopupData } = usePopups();
  ...
  const updateDetail = (index: number, value: string) => {
    setProductData(prev => ({
      ...prev,
      additional_details: prev.additional_details.map((detail, i) => i === index ? value : detail)
    }));
  };
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleProductChange('pieces_count', parseInt(e.target.value))}
                    placeholder="42"
                    className="mt-1"
                  />
                </div>
              ...
              <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                <Label className="text-sm font-medium text-yellow-800 mb-3 block">Star Rating & Reviews</Label>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleProductChange('reviews_count', parseInt(e.target.value))}
                      className="mt-1"
                    />
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2 mt-3">
                  ...
                  <Badge variant="secondary">{productData.rating.toFixed(1)} ⭐ ({productData.reviews_count} reviews)</Badge>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4 p-4 bg-green-50 rounded-lg border border-green-200">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleProductChange('original_price', parseFloat(e.target.value))}
                    className="mt-1"
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleProductChange('discounted_price', parseFloat(e.target.value))}
                    className="mt-1"
                  />
                </div>
                <div className="md:col-span-2 mt-2">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-gray-500 line-through">${productData.original_price.toFixed(2)}</span>
                    <span className="text-green-600 font-bold text-lg">${productData.discounted_price.toFixed(2)}</span>
                    <Badge variant="secondary">Save ${(productData.original_price - productData.discounted_price).toFixed(2)}</Badge>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-2">
                  <Input
                    ...
                    onChange={(e) => handleProductChange('popup_image', e.target.value)}
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) => handleExitChange('description', e.target.value)}
                  placeholder="Enter popup description..."
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleExitChange('email_placeholder', e.target.value)}
                ...
                <div>
                  <Label htmlFor="subscribe-button">Subscribe Button Text</Label>
                  <Input
                    id="subscribe-button"
                    value={exitData.subscribe_button_text}
                    onChange={(e) => handleExitChange('subscribe_button_text', e.target.value)}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleExitChange('dismiss_button_text', e.target.value)}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleExitChange('privacy_note', e.target.value)}
              ...
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                <Label className="text-sm font-medium text-blue-800 mb-3 block">Email Configuration</Label>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleExitChange('destination_email', e.target.value)}
                    placeholder="admin@yourdomain.com"
                    className="mt-1"
                  />
                  <p className="text-xs text-blue-600 mt-1">Email address where subscriptions will be sent</p>
                </div>
              </div>

              {/* Marketing Integrations */}
              <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                <Label className="text-sm font-medium text-gray-800 mb-3 block">Marketing Integrations (Optional)</Label>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleExitChange('mailchimp_api_key', e.target.value)}
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleExitChange('mailchimp_list_id', e.target.value)}
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleExitChange('brevo_api_key', e.target.value)}
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleExitChange('brevo_list_id', e.target.value)}
                      placeholder="Enter list ID..."
                      className="mt-1"
                    />
                  </div>
              ...
              <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                <Label className="text-sm font-medium text-purple-800 mb-3 block">Popup Preview</Label>
                <div className="bg-white rounded-lg p-4 border-2 border-gray-200 max-w-md mx-auto">
                  ...
                  <div className="text-sm text-gray-600 mb-4 whitespace-pre-line">{exitData.description}</div>
                  <Input placeholder={exitData.email_placeholder} className="mb-3" disabled />
                  <div className="flex gap-2">
                    <Button className="flex-1" disabled>{exitData.subscribe_button_text}</Button>
                    <Button variant="outline" disabled>{exitData.dismiss_button_text}</Button>
                  </div>
                  <p className="text-xs text-gray-500 mt-2">{exitData.privacy_note}</p>
                </div>
              </div>
            </CardContent>
          </Card>
