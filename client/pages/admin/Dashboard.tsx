  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Manage your website content, SEO, and tracking settings.</p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Admin Sections</CardTitle>
            <Settings className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">10</div>
            <p className="text-xs text-muted-foreground">Sections available for management</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Admin system operational</p>
          </CardContent>
        </Card>
        ...
        <CardContent>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <p className="text-sm text-gray-600">Configure meta tags and tracking</p>
            </div>
            <div className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
            ...
            <div className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <p className="text-sm text-gray-600">Manage product and exit popups</p>
            </div>
            <div className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
